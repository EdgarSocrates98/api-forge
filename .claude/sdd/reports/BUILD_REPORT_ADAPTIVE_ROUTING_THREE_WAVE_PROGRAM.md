...
|------|-------|--------|--------|
| 1 | `RoutingPlan`, papéis explícitos e execução compatível | ✅ Complete | pending in this build turn |
| 2 | scorecards multidimensionais, frescor e eval adversarial | ⏳ Pending | — |
