...
TOOL_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "wrk2": {
        "category": "load",
        "license": "Apache-2.0",
        "input": "CLI flags + constant-rate control",
        "output": "stdout summary + latency detail",
        "capabilities": ["constant-throughput correction — no coordinated omission"],
        "limits": ["single-endpoint"],
        "cost": "oss",
        "needs_network": True,
        "needs_credentials": False,
        "local_support": True,
        "aws_support": False,
        "parser": "apiforge.adapters.testreports.extract_wrk",
        "compat": {"runtime": "binary", "note": "wrk fork; same report shape"},
        "evidence_producer": "test.wrk.summary",
        "modes": ["local", "docker"],
        "runnable": False,
